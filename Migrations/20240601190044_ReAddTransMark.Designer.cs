...
namespace MyField.Migrations
{
    ...
    [Migration("20240601190044_ReAddTransMark")]
    partial class ReAddTransMark
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyField.Models.PlayerTransferMarket", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TransferMarketId"));
            ...
            modelBuilder.Entity("MyField.Models.Transfer", b =>
                {
                    ...
                    b.Property<int>("PlayerTransferMarketTransferMarketId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlayerTransferMarketTransferMarketId");
            ...
            modelBuilder.Entity("MyField.Models.AcceptedTransfer", b =>
                {
                    b.HasBaseType("MyField.Models.Transfer");
                    ...
                    b.ToTable("Transfer", t =>
                        {
                            t.Property("TransferAmount")
                                .HasColumnName("AcceptedTransfer_TransferAmount");
                        });

                    b.HasDiscriminator().HasValue("AcceptedTransfer");
                });

            modelBuilder.Entity("MyField.Models.RejectedTransfer", b =>
                {
                    b.HasBaseType("MyField.Models.Transfer");
                    ...
                    b.HasDiscriminator().HasValue("RejectedTransfer");
                });
            ...
            modelBuilder.Entity("MyField.Models.CancelledTransfer", b =>
                {
                    b.HasBaseType("MyField.Models.AcceptedTransfer");
                    ...
                    b.HasDiscriminator().HasValue("CancelledTransfer");
                });

            modelBuilder.Entity("MyField.Models.CompletedTransfer", b =>
                {
                    b.HasBaseType("MyField.Models.AcceptedTransfer");
                    ...
                    b.HasDiscriminator().HasValue("CompletedTransfer");
                });
            ...
            modelBuilder.Entity("MyField.Models.Transfer", b =>
                {
                    ...
                    b.HasOne("MyField.Models.PlayerTransferMarket", "PlayerTransferMarket")
                        .WithMany()
                        .HasForeignKey("PlayerTransferMarketTransferMarketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
