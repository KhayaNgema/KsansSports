...
namespace MyField.Migrations
{
    ...
    [Migration("20240805203851_AddReasoForLiveInterruption")]
    partial class AddReasoForLiveInterruption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyField.Models.Fixture", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Fixture");
            ...
            modelBuilder.Entity("MyField.Models.Live", b =>
                {
                    ...
                    b.Property<bool>("WentToHalfTime")
                        .HasColumnType("bit");
                    ...
                    b.HasDiscriminator().HasValue("Live");
            ...
            modelBuilder.Entity("MyField.Models.MatchFormation", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("MatchFormation");
            ...
            modelBuilder.Entity("MyField.Models.MatchResults", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("MatchResults");
            ...
            modelBuilder.Entity("MyField.Models.Reports", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Reports");
            ...
            modelBuilder.Entity("MyField.Models.SportNews", b =>
                {
                    ...
                    b.Property<string>("ReasonForReEdit")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyField.Models.TopAssist", b =>
                {
                    b.Property<int>("TopAssistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TopAssistId"));
                    ...
                    b.HasKey("TopAssistId");

                    b.HasIndex("LeagueId");

                    b.HasIndex("PlayerId");

                    b.ToTable("TopAssists");

                    b.HasDiscriminator().HasValue("TopAssist");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("MyField.Models.TopScore", b =>
                {
                    b.Property<int>("TopScoreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TopScoreId"));
                    ...
                    b.HasDiscriminator().HasValue("TopScore");
            ...
            modelBuilder.Entity("MyField.Models.RedCard", b =>
                {
                    ...
                    b.ToTable("LiveEvents", t =>
                        {
                            t.Property("RedCardReason")
                                .HasColumnName("RedCardReason1");
            ...
            modelBuilder.Entity("MyField.Models.YellowCard", b =>
                {
                    ...
                    b.ToTable("LiveEvents", t =>
                        {
                            t.Property("YellowCardReason")
                                .HasColumnName("YellowCardReason1");
            ...
            modelBuilder.Entity("MyField.Models.PlayerPerformanceReport", b =>
                {
                    ...
                    b.Property<int>("AppearancesCount")
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator().HasValue("PlayerPerformanceReport");
                });
            ...
            modelBuilder.Entity("MyField.Models.TopAssists_Archive", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TopAssists_Archive");
                });

            modelBuilder.Entity("MyField.Models.TopScores_Archive", b =>
                {
            ...
            modelBuilder.Entity("MyField.Models.PlayerPerformanceReports_Archive", b =>
                {
                    b.HasBaseType("MyField.Models.PlayerPerformanceReport");

                    b.HasDiscriminator().HasValue("PlayerPerformanceReports_Archive");
                });
