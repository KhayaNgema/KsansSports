...
namespace MyField.Migrations
{
    ...
    [Migration("20240601181845_ChangeIdValueAndName")]
    partial class ChangeIdValueAndName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyField.Models.Transfer", b =>
                {
                    ...
                    b.Property<int>("PlayerTransferMarketMarketId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlayerTransferMarketMarketId");
            ...
            modelBuilder.Entity("MyField.Models.Transfer", b =>
                {
                    ...
                    b.HasOne("MyField.Models.PlayerTransferMarket", "PlayerTransferMarket")
                        .WithMany()
                        .HasForeignKey("PlayerTransferMarketMarketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
